...
``time`` filter allows to specify a date range for the files to download. It should be provided as a tuple of two strings in
"YYYY-MM-DD" format, or as a tuple of two ``np.datetime64`` values.
